...
MONGO_URI ="mongodb+srv://admin:2hByV21RRNPstsjn@cluster0.ovrcg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
DB_NAME ="courses_db"
COLLECTION_NAME ="cours_python"

# Répertoire contenant les PDFs
PDF_PATH = "cours"  # À modifier selon votre structure
